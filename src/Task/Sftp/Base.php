...
abstract class Base extends BaseTask
{
     ...
     * @return $this Returns this SFTP object to allow for method chaining.
     *
     * @throws \src\Task\Sftp\Exceptions\ConfigurationMissingException
     * @throws \src\Task\Sftp\Exceptions\ConfigurationParsingException
     */
    public function loadConfiguration(string $path = self::DEFAULT_CONFIG_FILE): self
    {
        ...
        if($real = realpath($path)) {
            ...
            if (json_last_error() !== JSON_ERROR_NONE)
                throw new \src\Task\Sftp\Exceptions\ConfigurationParsingException(
